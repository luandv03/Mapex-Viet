        ...
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight ">
                    Đăng ký tài khoản với MapexViet
                </h2>
            </div>
            ...
            <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <fieldset className="border-b my-6 w-full text-center ">
                    <span className="text-base text-gray-500 px-4">
                        Để tiếp tục hãy đăng ký tài khoản tại đây
                    </span>
                </fieldset>
                <form className="space-y-2 mt-4" action="#" method="POST">
                    <div className="pl-1 w-full rounded-md border-0 py-1.5  sm:text-sm sm:leading-6 flex justify-between gap-x-1">
                        <div className="basis-1/2">
                            ...
                            <div>
                                <input
                                    ...
                                    id="first-name"
                                    placeholder="Dinh"
                                    className="pl-1 w-full  rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-200 sm:text-sm sm:leading-6"
                                />
                            </div>
                        </div>
                        <div className="basis-1/2">
                    ...
                    <div>
                        ...
                        <div>
                            <input
                                ...
                                required
                                className="pl-1 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-200 sm:text-sm sm:leading-6"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                required
                                className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-200 sm:text-sm sm:leading-6 pl-1"
                            />
